...
struct retro_core_option_v2_category option_cats_us[] = {
   ...
   },
   {
      "ips",
      "IPS Patches",
      "Configure manual IPS patch selection."
   },
   { NULL, NULL, NULL },
};
...
struct retro_core_option_v2_definition option_defs_us[] = {
...

   {
      ...
      "IPS Patches",
      NULL,
      "Default: Auto-load traditional named IPS. Enabled: Manual select custom named patches (gamename.patchname.ips). Disabled: No patches.",
      NULL,
      "ips",
      {
         { "default",  "Default" },
   ...
   },
   {
      ...
      "Patch 0",
      NULL,
      "Apply priority (lower = first, same = alphabetical). Set to disabled to skip this patch.",
      NULL,
      "ips",
      {
         { "disabled", "Disabled" },
